...
2. **Скачай проект**: на [странице репозитория](https://github.com/dimalebedeff/downy) нажми зелёную кнопку **Code → Download ZIP** и распакуй архив в любую постоянную папку (например, `D:\downy`). Не удаляй её потом — браузер запускает расширение и CoApp прямо из неё.
