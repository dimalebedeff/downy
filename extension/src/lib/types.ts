...
export interface MediaItem {
  ...
  pageUrl?: string;
  pageTitle?: string;
  /** Документ, который реально запросил медиа. У встроенного плеера это адрес
   *  его собственного фрейма, и CDN ждёт в Referer именно его: подсунешь адрес
   *  статьи со СМИ — плеер ответит отказом, и загрузка упадёт на старте */
  frameUrl?: string;
