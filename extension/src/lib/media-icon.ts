...
export function mediaKindFromFile(nameOrPath: string | undefined): MediaKind {
...
const ICON_PATH: Record<MediaKind, string> = {
...
export function typeIconSvg(kind: MediaKind): string {
